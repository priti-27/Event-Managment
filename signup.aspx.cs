   ...
   protected void Page_Load(object sender, EventArgs e)
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string query = "insert into signup(firstname,lastname,username, password,mobileno,email,address) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox8.Text + "','" + TextBox7.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "')";
